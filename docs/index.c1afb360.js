...
})({"iQscO":[function(require,module,exports) {
"use strict";
...
const simpleRouter = function() {
    ...
    let loadedSection = document.querySelector("#app").getAttribute("data-section");
    ...
    } else (0, _fetchArticles.fetchArticles)(urlHash);
};
...
const navLink = function(e) {
    if ("section" in e.target.dataset) {
        document.querySelector("#app").setAttribute("data-section", e.target.dataset.section);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iQscO","8lRBv"], "8lRBv", "parcelRequire2c69")
